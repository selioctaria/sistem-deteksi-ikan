...
OUTPUT_CSV = r"D:\Documents\SKRIPSI\PROGRAM SISTEM DETEKSI IKAN\svm\hasil\hasil_testing2.csv"
CONF_MATRIX_IMG = r"D:\Documents\SKRIPSI\PROGRAM SISTEM DETEKSI IKAN\svm\confusion_matrix2.png"
...
# ===============================
# PISAHKAN GAMBAR BENAR & SALAH
# ===============================
df_benar = df_testing[df_testing["Status"] == "Benar"]
df_salah = df_testing[df_testing["Status"] == "Salah"]

path_benar = r"D:\Documents\SKRIPSI\PROGRAM SISTEM DETEKSI IKAN\svm\hasil\gambar_benar.csv"
path_salah = r"D:\Documents\SKRIPSI\PROGRAM SISTEM DETEKSI IKAN\svm\hasil\gambar_salah.csv"

df_benar.to_csv(path_benar, index=False)
df_salah.to_csv(path_salah, index=False)

print("📁 CSV gambar BENAR disimpan di:", path_benar)
print("📁 CSV gambar SALAH disimpan di:", path_salah)
