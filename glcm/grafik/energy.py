...
# =========================
# CARI KOLOM energy (AMAN HURUF BESAR/KECIL)
# =========================
energy_column = None
...
if energy_column is None:
    raise ValueError("Kolom energy tidak ditemukan di CSV!")
...
bars = plt.bar(kelas, energy_values)
...
plt.title("Perbandingan Rata-rata Energy per Kadar Garam Ikan", fontsize=14, fontweight='bold')
plt.xlabel("Kategori Kadar Garam", fontsize=12)
plt.ylabel("Rata-rata Energy", fontsize=12)
...
output_path = os.path.join(output_folder, "grafik_energy_per_label.png")
