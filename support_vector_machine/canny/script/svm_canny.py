# =========================================================
# SVM - CANNY ONLY (BASELINE MODEL) - FULL VERSION
# =========================================================
...
MODEL_DIR = os.path.join(BASE_PATH, "support_vector_machine/canny/model")
HASIL_DIR = os.path.join(BASE_PATH, "support_vector_machine/canny/hasil")

MODEL_PATH  = os.path.join(MODEL_DIR, "svm_canny.pkl")
SCALER_PATH = os.path.join(MODEL_DIR, "scaler_canny.pkl")
...
# VALIDASI KOLOM
# =========================================================
required_cols = ["Edge_Pixels", "Edge_Ratio", "Label"]
...
# FITUR CANNY ONLY
# =========================================================
X_train = df_train[["Edge_Pixels", "Edge_Ratio"]]
y_train = df_train["Label"]

X_val = df_val[["Edge_Pixels", "Edge_Ratio"]]
y_val = df_val["Label"]

X_test = df_test[["Edge_Pixels", "Edge_Ratio"]]
...
plt.xlabel("Prediksi")
plt.ylabel("Aktual")
plt.title("Confusion Matrix - SVM Canny Only")
...
print("\n🎉 SELESAI - CANNY ONLY BASELINE MODEL")